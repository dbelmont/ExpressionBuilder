...
namespace ExpressionBuilder.Test
{
    ...
    public class FilterXmlSerializerTests
    {
        ...
        public void Setup()
        {
            ...
            sb.Append("      <PropertyName>Id</PropertyName>");
            ...
            sb.Append("      <PropertyName>Gender</PropertyName>");
        ...
        {
            var serializer = new XmlSerializer(typeof(FilterStatement<Person>));
            ...
            Assert.That(root.SelectSingleNode("PropertyName").InnerText, Is.EqualTo("Id"));
        ...
        public void SerializeFilterStatementWithEnumValue()
        {
            ...
            Assert.That(root.SelectSingleNode("PropertyName").InnerText, Is.EqualTo("Gender"));
        ...
        public void SerializeFilterStatementWithDateTimeValue()
        {
            ...
            Assert.That(root.SelectSingleNode("PropertyName").InnerText, Is.EqualTo("Birth.Date"));
